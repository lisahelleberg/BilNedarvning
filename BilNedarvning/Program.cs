...
namespace BilNedarvning
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            dieselBilListe.Add(new DieselBil("Ford", 150000, 2011, 15.6, "GH 59 356", true));
            dieselBilListe.Add(new DieselBil("Ferrari", 350000, 2016, 8.5, "HD 89 125", true));
            dieselBilListe.Add(new DieselBil("Honda", 180000, 2014, 21.6, "JG 13 159", true));
            dieselBilListe.Add(new DieselBil("Toyota", 110000, 2010, 25.8, "EJ 79 678", false));
            dieselBilListe.Add(new DieselBil("VW", 190000, 2017, 18.9, "WP 16 795", false));
